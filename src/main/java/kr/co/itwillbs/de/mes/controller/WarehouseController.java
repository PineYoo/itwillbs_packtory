...
public class WarehouseController {
	...
	private final String PATH = "/mes/warehouse";
	...
	public String getWarehouse(@PathVariable("idx") Long idx, Model model) {
		...
		return PATH + "/warehouse_detail";
	}

	// 창고 수정
	@PutMapping("/updateWarehouse")
	public ResponseEntity<Map<String, Object>> updateWarehouse(@RequestBody WarehouseDTO warehouseDTO) {
		log.info("{}---start", Thread.currentThread().getStackTrace()[1].getMethodName());
