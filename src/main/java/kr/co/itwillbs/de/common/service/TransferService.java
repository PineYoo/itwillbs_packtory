...
//	private final OutTransferCommand outTransferCommand;
	...
	@PostConstruct
	public void init() {
		commandMap.put(TransType.IN, inTransferCommand);
		commandMap.put(TransType.QC, qcTrasnFerCommand);
		commandMap.put(TransType.MOVE, generalTransferCommand);
//		commandMap.put(TransType.OUT, outTransferCommand);
		// ... 추가
	}
